...
class TestStringsFunctions:
    ...
    ], ids=["windows_path", "relative_path", "unix_path", "double_extension"])  # Удален лишний идентификатор
    ...
    @pytest.mark.parametrize("original, encrypted", [
        ...
        ('A', 'A'), 
        ('', ''), 
    ], ids=["normal", "with_punctuation", "even_length", "single_char", "empty_string"])
    ...
    @pytest.mark.parametrize("expression, expected", [
        ...
        ('no brackets', 0), 
        ('', 0), 
    ], ids=["valid", "invalid_start", "extra_close", "unclosed", "no_brackets", "empty"])
    ...
    @pytest.mark.parametrize("domain, reversed_domain", [
        ...
        ('a.b.c.d', 'd.c.b.a'), 
        ('single', 'single'), 
    ], ids=["standard", "second_level", "no_dots", "multiple_subdomains", "single_word"])
    ...
    @pytest.mark.parametrize("word, count", [
        ...
        ('xyz', 0), 
        ('', 0), 
    ], ids=["mixed_case", "all_upper", "only_y", "all_vowels", "no_vowels", "empty"])
